...
namespace Oriflame.PolicyBuilder.Policies.Builders.Fluent.Sections
{
    public interface IInboundSectionPolicyBuilder : IPolicySectionBuilder<IInboundSectionPolicyBuilder>
    {
        ...
        IInboundSectionPolicyBuilder ValidateJwt(Func<IJwtValidationAttributesBuilder, IDictionary<string, string>> jwtAttributesBuilder, string openIdConfigUrl = null, IEnumerable<string> issuers = null, Func<IRequiredClaimSectionBuilder, ISectionPolicy> requiredClaimsBuilder = null);
